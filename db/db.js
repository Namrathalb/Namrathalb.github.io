export default {
	...
	community: [
		...
		{
			title: "Code to Express",
			duration: "Aug 2019 - Aug 2021",
			subtitle: "Community Volunteer",
			details: [
				"Handled and co-ordinated with teams in sharing all the notable meetups, tech events conferences and job updates to students and working professionals to grow network.",
			],
			tags: ["Social Media", "Community Building", "LinkedIn",],
			icon: "code",
		},
	],
	...
	education: [
		{
			...
			tags: [
				...
				"Operating Systems", "Blockchain", "C/C++", "Internet of Things",
				"DBMS (MySQL)", "Java",	"Web stack ( HTML, CSS, js)",	
				"Compiler Designing", "Machine Learning", "Big Data",
			],
			icon: "graduation-cap",
		},
		{
		...
		{
			title: "Mary Immaculate Girl's High School",
	...
	footer: [
		{
			...
			data: [
				{
					text: "GitHub",
					link: "https://github.com/Namrathalb",
				},				
			],
		},
		{
			...
			data: [
				...
				},
				{
					...
					link: "https://github.com/Namrathalb/Namrathalb.github.io",
				},
			],
		},
		{
			...
			data: [
				{
					text: "Linkedin",
					link: "https://www.linkedin.com/in/namratha-l-bemane/",
				},
				{
					text: "Twitter",
					link: "https://twitter.com/namratha_bemane",
				},
				{
					text: "Instagram",
					link: "https://www.instagram.com/namratha.bemane/",
				},
			],
		},
		{
			...
			data: [
				"Made with &hearts; by Namratha L Bemane.",
